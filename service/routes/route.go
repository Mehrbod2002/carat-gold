...
func SetupRouter(dataChannel chan interface{}) *gin.Engine {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://0.0.0.0:3001", "http://ali-asgari.com", "http://localhost:3001", "http://127.0.0.1:5173", "https://admin.goldshop24.co", "https://goldshop24.co", "https://server.goldshop24.co"},
	...
	userRoutes.Use(AuthMiddleware())
	{
		...
		userRoutes.GET("/delivery_methods", user.UserDeliveryMethods)
